...
const adminMenuItems = ['Dashboard', 'Analytics', 'Evaluation', 'Reports', 'Settings']
...
function App() {
  ...
  useEffect(() => {
    if (!selectedAnalyticsIntern) return undefined
    const onKeyDown = (event) => {
      if (event.key === 'Escape') setSelectedAnalyticsIntern(null)
    }
  ...
  const careersMarqueeRows = useMemo(() => {
    const shuffle = (array) => {
      const arr = [...array]
    ...
    const shortRowSize = 6
    const rowOne = shuffle(careersCultureChips).slice(0, shortRowSize)
    const rowTwo = shuffle(careersCultureChips)
    const rowThree = shuffle(careersCultureChips).slice(0, shortRowSize)

    const edgeSpeed = `${14 + Math.floor(Math.random() * 5)}s`
    const middleSpeed = `${18 + Math.floor(Math.random() * 5)}s`

    return [
      { chips: rowOne, reverse: true, speed: edgeSpeed },
      { chips: rowTwo, reverse: false, speed: middleSpeed },
      { chips: rowThree, reverse: true, speed: edgeSpeed },
    ]
  }, [])
  ...
  if (currentPath !== '/') {
    return (
      <div className="w-full overflow-x-hidden min-h-screen">
        ...
        <main className={`${isAdminRoute ? 'pt-5' : 'pt-20'} px-4 sm:px-6 lg:px-8 pb-14`}>
          {currentPath === '/ai-services' ? (
            <section className="max-w-6xl mx-auto space-y-8 relative text-black">
              ...
              >
                ...
                <div className="text-center mb-8">
                  <p className="text-sm sm:text-base text-black mb-4 inline-flex items-center gap-2">
                    <Sparkles className="w-4 h-4 text-castleton" />
            ...
            <section className="max-w-6xl mx-auto space-y-8 relative text-black">
              ...
              <motion.section
                ...
                transition={{ duration: 0.45 }}
              >
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-end min-h-[320px]">
                  <motion.div
              ...
              >
                ...
                <div className="careers-chip-marquee-stack mt-8 space-y-3 sm:space-y-4">
                  <div className="careers-chip-lane careers-chip-lane-top careers-chip-fade-shell max-w-[84%] mx-auto overflow-hidden rounded-2xl sm:rounded-3xl py-2">
                    <div
                      className={`careers-chip-track ${careersMarqueeRows[0].reverse ? 'careers-chip-track-reverse' : ''}`}
                      style={{ '--chip-speed': careersMarqueeRows[0].speed }}
                    >
                      {[...careersMarqueeRows[0].chips, ...careersMarqueeRows[0].chips].map((chip, index) => (
                        <motion.span
                          key={`r1-${chip}-${index}`}
                          className="careers-chip-badge shrink-0 px-3 py-1.5 text-sm sm:text-base font-medium"
                          whileHover={{ y: -2 }}
                  ...
                  <div className="careers-chip-lane careers-chip-lane-middle careers-chip-fade-shell max-w-full mx-auto overflow-hidden rounded-2xl sm:rounded-3xl py-2">
                    <div
                      className={`careers-chip-track ${careersMarqueeRows[1].reverse ? 'careers-chip-track-reverse' : ''}`}
                      style={{ '--chip-speed': careersMarqueeRows[1].speed }}
                    >
                      {[...careersMarqueeRows[1].chips, ...careersMarqueeRows[1].chips].map((chip, index) => (
                        <motion.span
                          key={`r2-${chip}-${index}`}
                          className="careers-chip-badge shrink-0 px-3 py-1.5 text-sm sm:text-base font-medium"
                          whileHover={{ y: -2 }}
                  ...
                  <div className="careers-chip-lane careers-chip-lane-bottom careers-chip-fade-shell max-w-[84%] mx-auto overflow-hidden rounded-2xl sm:rounded-3xl py-2">
                    <div
                      className={`careers-chip-track ${careersMarqueeRows[2].reverse ? 'careers-chip-track-reverse' : ''}`}
                      style={{ '--chip-speed': careersMarqueeRows[2].speed }}
                    >
                      {[...careersMarqueeRows[2].chips, ...careersMarqueeRows[2].chips].map((chip, index) => (
                        <motion.span
                          key={`r3-${chip}-${index}`}
                          className="careers-chip-badge shrink-0 px-3 py-1.5 text-sm sm:text-base font-medium"
                          whileHover={{ y: -2 }}
            ...
            isAdminAuthenticated ? (
              <section className="max-w-[1400px] mx-auto text-black">
                <div className="grid grid-cols-1 lg:grid-cols-[240px,1fr] gap-4">
                  <aside className="rounded-[26px] border border-castleton/25 bg-[linear-gradient(165deg,#0f5a3f,#0d4d38_52%,#0a3f31)] text-[#eef4e9] overflow-hidden shadow-soft">
                    <div className="px-5 py-5 border-b border-white/20">
                      <div className="flex items-center gap-2">
                        <span className="inline-flex w-8 h-8 rounded-full items-center justify-center bg-saffron text-black font-bold">L</span>
                        <p className="text-xl font-semibold">Lifewood</p>
                      </div>
                      <p className="text-xs text-white/80 mt-1">Admin Hub</p>
                    </div>
                  ...
                  <div className="rounded-[26px] border border-castleton/20 bg-[#edf0ee] p-4 sm:p-6">
                          ...
                          <div className="space-y-4">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                              {[
                                ...
                                <motion.article
                                  key={card.title}
                                  className={`rounded-[22px] border border-castleton/15 bg-gradient-to-br ${card.accent} p-5`}
                                  initial={{ opacity: 0, y: 10 }}
                                  animate={{ opacity: 1, y: 0 }}
                                  whileHover={{ y: -3 }}
                          ...
                          <div className="space-y-4">
                              ...
                              <div className="space-y-2">
                                {presentInterns.slice(0, 5).map((person, idx) => (
                                  <button
                                    ...
                                    className="w-full rounded-xl border border-castleton/10 bg-[#f8faf9] px-3 py-2 flex items-center justify-between hover:border-castleton/30 transition-colors"
                                  >
                              ...
                              <div className="space-y-2">
                                {leaveInterns.map((person, idx) => (
                                  <button
                                    ...
                                    className="w-full rounded-xl border border-castleton/10 bg-[#fdfdfd] px-3 py-2 flex items-center justify-between hover:border-castleton/30 transition-colors"
                                  >
                                    <span className="font-medium text-black">{person.name}</span>
                            ...
                            >
                              ...
                              {birthdayInterns.map((person) => (
                                <div key={person.name} className="rounded-xl border border-castleton/10 bg-[#f8f9ff] px-3 py-3">
              ...
              >
                ...
                <div className="mt-7 grid grid-cols-1 sm:grid-cols-3 gap-3 w-full max-w-4xl">
                  <div className="bg-[#f3f3f3] border border-castleton/15 rounded-2xl py-4 px-4">
                    <p className="text-3xl sm:text-4xl font-semibold text-castleton">56,788</p>
                    <p className="text-sm sm:text-base text-black/80">Online Resources</p>
                  </div>
                  <div className="bg-[#f3f3f3] border border-castleton/15 rounded-2xl py-4 px-4">
                    <p className="text-3xl sm:text-4xl font-semibold text-castleton">30+</p>
                    <p className="text-sm sm:text-base text-black/80">Countries</p>
                  </div>
                  <div className="bg-[#f3f3f3] border border-castleton/15 rounded-2xl py-4 px-4">
                    <p className="text-3xl sm:text-4xl font-semibold text-castleton">40+</p>
