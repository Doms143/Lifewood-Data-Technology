...
const LightPillar = ({
  ...
  useEffect(() => {
    ...
    const qualitySettings = {
      low: { iterations: 18, waveIterations: 1, pixelRatio: 0.45, precision: 'mediump', stepMultiplier: 1.6 },
      medium: { iterations: 28, waveIterations: 1, pixelRatio: 0.55, precision: 'mediump', stepMultiplier: 1.35 },
      high: {
        iterations: 80,
        waveIterations: 4,
    ...
    const targetFPS = effectiveQuality === 'high' ? 60 : 40
